...
Public Class rptAccStatmnt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim AccNo = Request.QueryString("AccNo")

        Dim kk As String = ""
        kk = Server.MapPath("rptAccountStatements.rpt")
        ...
        cryRpt.SetParameterValue("from", from)
        cryRpt.SetParameterValue("dto", dto)
        cryRpt.SetParameterValue("AccNo", AccNo)
