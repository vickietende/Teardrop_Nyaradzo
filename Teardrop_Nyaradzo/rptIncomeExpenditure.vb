...
Public Class rptIncomeExpenditure
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptIncomeExpenditure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Teardrop_Nyaradzo.rptIncomeExpenditure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dto() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptIncomeExpenditure
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIncomeExpenditure = New rptIncomeExpenditure()
        rpt.Site = Me.Site
        Return rpt
    End Function
