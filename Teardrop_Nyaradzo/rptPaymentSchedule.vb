...
Public Class rptPaymentSchedule
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Teardrop_Nyaradzo.rptPaymentSchedule.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentSchedule
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentSchedule = New rptPaymentSchedule()
        rpt.Site = Me.Site
        Return rpt
    End Function
