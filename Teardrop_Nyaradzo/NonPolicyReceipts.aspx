<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="NonPolicyReceipts.aspx.vb" Inherits="Teardrop_Nyaradzo.NonPolicyReceipts" %>
<%@ Register
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4 style="padding-left:20px;color:white;">Non-Policy Holders Payment Receipts</h4>
       ...
       <div class="row">
        ...
        <div class="col-xs-3 control-label" style="padding-left:20px;">
                        ...
                        <div class="col-xs-6" style="padding-left:20px;">
                            <asp:TextBox  ID="txtIDNO" runat="server" Width="200px"  autocomplete="off"></asp:TextBox>
