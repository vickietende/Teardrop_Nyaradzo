...
Public Class rptReportCustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Teardrop_Nyaradzo.rptReportCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReportCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReportCustomers = New rptReportCustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
