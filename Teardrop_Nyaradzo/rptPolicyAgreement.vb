...
Public Class rptPolicyAgreement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Teardrop_Nyaradzo.rptPolicyAgreement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPolicyAgreement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPolicyAgreement = New rptPolicyAgreement()
        rpt.Site = Me.Site
        Return rpt
    End Function
