...
Public Class rptSSBProcessed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Teardrop_Nyaradzo.rptSSBProcessed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSSBProcessed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSSBProcessed = New rptSSBProcessed()
        rpt.Site = Me.Site
        Return rpt
    End Function
